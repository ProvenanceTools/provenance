/**
 * Migration 0026 applied to a database that ALREADY HAS `students` rows.
 *
 ...
 * prove is the UPGRADE direction — 0026 landing on a deployment that has been
 ...
 *     why the two eras cannot be merged, and 0026 changes none of that;
...
const TAG_0026 = '0026_student_credentials';
...
describe('migration 0026 — credential history', () => {
  it('applies to a database that already has students, and backfills without fabricating', async () => {
    ...
    try {
      ...
      // ---------------------------------------------------------------------
      // 3. Apply 0026 on top of that populated database.
      // ---------------------------------------------------------------------
